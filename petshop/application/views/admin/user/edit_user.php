            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="<?=base_url();?>user/edit_aksi" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" name="email" value="<?php echo $hasil->email; ?>" class="form-control" id="exampleInputEmail1" placeholder="Email">
                    </div>
                    <div class="form-group">
                      ...
                      <select name="role" id="exampleFormControlSelect2" class="form-control form-control-lg">
                          ...
                          <?php foreach ($role as $m) : ?>
                              <option value="<?= $m->id_role; ?>" <?= $m->id_role == $hasil->role_id ? "selected" : null ?>><?= $m->role; ?></option>
                          <?php endforeach; ?>
                      </select>
                    </div>
