        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4>Hello! Selamat Data Di <?=$title;?></h4>
              <h6 class="font-weight-light">Login Sistem</h6>
              <?= $this->session->flashdata('message');?>
              <form class="pt-3" action="<?=base_url();?>auth" method="post" enctype="multipart/form-data">
                ...
                <div class="mt-3">
                  <button type="submit" value="kirim" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">LOG IN</button>
                </div>
                ...
                <div class="text-center mt-4 font-weight-light">
                  Baru di Petshop? <a href="<?=base_url('auth/register');?>" class="text-primary">Daftar</a>
                </div>
              </form>
            </div>
          </div>
